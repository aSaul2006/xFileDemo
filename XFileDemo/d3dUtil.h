...
public:
	...
	void load();
	void unload(){};
	void setMeshMtTx(ID3DXMesh* &tempMesh, std::vector<Mtrl> tempMtrl, std::vector<IDirect3DTexture9*> tempTex);
	ID3DXMesh* getMesh();
	std::vector<IDirect3DTexture9*> getTex();
	std::vector<Mtrl> getMtrl();	
